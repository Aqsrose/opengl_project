...
void createNewWindow(void);	//created new window, probably used for setting up things for every window creation?
...
void displayHelp(const char str[], float x, float y);
void displayText();
void displayTextGod();
